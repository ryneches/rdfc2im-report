...
\begin{frame}[t]
  ...
  \vspace{1mm}
  \sub{The mapping is data, not code.\quad
       \textcolor{muted}{(HumanMine: no data release since February 2022.)}}
  \vspace{2.5mm}
  \centering
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south, fill=shared!10, minimum width=\paperwidth, inner sep=1.4mm,
      ...
      {\fontsize{6.5}{8}\selectfont
       ...
       Gos Micklem (Univ.\ of Cambridge)\enspace\textbullet\enspace DBCLS BioHackathon 2026};
  \end{tikzpicture}
\end{frame}
